package com.sha.serverside.jwt;
...
public class JwtTokenProvider {
	...
	public String generatedToken(Authentication auth) {
	  ...
	  return Jwts.builder().setSubject(auth.getName()).claim("roles",
			  authorities).setExpiration(new Date(System.currentTimeMillis() + jwtExpirationInMs))
	...
	private String resolveToken (HttpServletRequest req){
		...
		String bearerToken =req.getHeader(jwtExpirationInMs);
